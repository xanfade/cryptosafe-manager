...
def test_timing_attack_constant_time_behavior():
    ...
    s_equal = _mean_compare_ns(constant_time_compare_str, "vault-session-token", "vault-session-token")
    s_mismatch = _mean_compare_ns(constant_time_compare_str, "vault-session-token", "vault-session-t0ken")
